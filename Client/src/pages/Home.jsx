        ...
        <div className="max-w-7xl mx-auto px-6 pt-20 pb-16">
          <div className="text-center space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-4">
              ...
              <button onClick={() => navigate("/rooms")} className="px-8 py-4 bg-white text-[var(--brand-secondary)] rounded-2xl font-semibold shadow-md hover:shadow-lg border-2 border-[var(--brand-primary)] hover:border-[var(--brand-secondary)] transform hover:-translate-y-1 transition-all duration-200 flex items-center gap-2">
